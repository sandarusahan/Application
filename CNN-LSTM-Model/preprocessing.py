...
def extract_faces_from_video(video_path, output_folder, num_frames=-1, output_vid = False):
    ...
    if len(face_frames) > 0 and output_vid:
...
#     dir = 'D:\MSc\OneDrive - MMU\Documents\MSc\Dissertation\Datasets\Celeb-DF\Celeb-DF\Real'
#     files = glob.glob(os.path.join(dir, '*.mp4'))
#     # print(files)
#     # video_path = "../sample.mp4"
#     output_folder = "Output\Real1"  # Folder to save the extracted faces
